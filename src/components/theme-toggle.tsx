...
export function ThemeToggle() {
  ...
  const isDark = theme === "dark" || (isSystem && window.matchMedia('(prefers-color-scheme: dark)').matches)
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Toggle theme (long press for system default)</span>
    </Button>
  )
}
